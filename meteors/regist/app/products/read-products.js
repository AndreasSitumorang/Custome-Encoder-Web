...
//         $.getJSON("http://localhost/Restfull_php/api/product/read.php", function(data){
...
function showProductsFirstPage(){
    var json_url="http://localhost/meteors/regist/product/read_paging.php";
    showProducts(json_url);
}
...
function showProducts(json_url){
    ...
    $.getJSON(json_url, function(data){
        ...
        // change page title
        changePageTitle("Show The Events");
