...
class Base64
{
	const AES256		= 2; //new add

	const WORD_LENGTH 	= 4; //new add
	const BYTE_LENGTH	= 8; //new add
	...
	public function encrypt($content) {
		...
		$value = $this->stringToHex($content);

		$this->state = $this->convertToWords($value);
		...
		$encoder = $this->convertToHexString();
	...
	public function decrypt($content) {
		...
		$this->state = $this->convertToWords($decoded);
		...
		$this->invSubBytes();
		// $this->addRoundKey($this->createRoundKey(0, $expand_key));
		$result= $this->convertToHexString();
		return $this->hexToString($result);
